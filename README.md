...
# Installation
StackLayoutManager is a single Kotlin file, so you just need to copy the [`StackLayoutManager.kt`](https://raw.githubusercontent.com/DarkionAvey/StackLayoutManager/master/stacklayoutmanager/src/main/java/library/StackLayoutManager.kt) file to your project and change the `package` declaration. That's it!
